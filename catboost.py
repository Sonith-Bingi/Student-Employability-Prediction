...
print("Accuracy of CatBoostClassifier: " + str(accuracy))
print("Precision of CatBoostClassifier: " + str(precision))
print("Recall of CatBoostClassifier: " + str(recall))
print("F1 Score of CatBoostClassifier: " + str(f1score))
